...
function init() {
    ...
    // Nota: Asegúrate de que esta ruta apunte correctamente a donde tienes la textura de atlas.png
    const texture = new THREE.TextureLoader().load( './assets/img/minecraft/atlas.png' );
